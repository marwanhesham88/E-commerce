...
let formik = useFormik({
  ...
  return <>
   <Helmet>
                ...
                <meta name="keywords" content="verify-code" />      
  </Helmet>
...
{ApiError ?  <div className='w-1/2 mx-auto bg-red-600 text-white font-bold rounded-lg p-3 mb-3'>
  ...
  <h2 className='font-bold text-2xl text-emerald-600 mb-3'>please enter your verify code</h2>
  ...
  <div className="relative z-0 w-full mb-5 group">
      ...
      <label htmlFor="resetCode" className="left-0 peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-emerald-600 peer-focus:dark:text-emerald-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">code</label>
  </div>
